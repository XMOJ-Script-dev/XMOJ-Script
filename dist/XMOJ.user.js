...
(function () {
     ...
     */
    let CodeSizeToStringSize$1 = (Memory) => {
        try {
            if (UtilityEnabled("AddUnits")) {
                if (Memory < 1024) {
                    return Memory + "B";
     ...
     */
    let storeCredential$1 = async (username, password) => {
     ...
     */
    let GetUserInfo$1 = async (Username) => {
        try {
     ...
     */
    let GetUserBadge$1 = async (Username) => {
        try {
     ...
     */
    let GetUsernameHTML$1 = async (Element, Username, Simple = false, Href = "https://www.xmoj.tech/userinfo.php?user=") => {
        try {
            ...
            let UserInfo = await GetUserInfo$1(Username);
            if (UserInfo === null) {
            ...
            if (!Simple) {
                ...
                let BadgeInfo = await GetUserBadge$1(Username);
...
td {
     ...
     * @param {Object} context - Shared context object with dependencies
     */
    async function initializePage(context) {
        const pathname = location.pathname;
    ...
    window.PurifyHTML = PurifyHTML$1;
    window.SmartAlert = SmartAlert;
    window.GetRelativeTime = GetRelativeTime;
    window.SecondsToString = SecondsToString;
    window.StringToSeconds = StringToSeconds;
    window.TimeToStringTime = TimeToStringTime$1;
    window.SizeToStringSize = SizeToStringSize$1;
    window.CodeSizeToStringSize = CodeSizeToStringSize$1;
    window.compareVersions = compareVersions;
    window.RequestAPI = RequestAPI;
    window.storeCredential = storeCredential$1;
    window.getCredential = getCredential$1;
    window.clearCredential = clearCredential;
    window.RenderMathJax = RenderMathJax$1;
    window.TidyTable = TidyTable;
    window.GetUserInfo = GetUserInfo$1;
    window.GetUserBadge = GetUserBadge$1;
    window.GetUsernameHTML = GetUsernameHTML$1;
