/**
 * Bootstrap initialization and main application logic
 */

import { UtilityEnabled } from './config.js';
import { AdminUserList } from './constants.js';
...
// NavbarStyler class for styling the navigation bar
...
// Utility function to replace markdown images
        ...
        if (location.host != "www.xmoj.tech") {
            ...
            if (document.querySelector("#navbar") != null) {
                ...
                if (UtilityEnabled("ReplaceYN")) {
                    let Temp = document.getElementsByClassName("status_y");//AC
                ...
                let Temp = document.getElementsByClassName("page-item");
                for (let i = 0; i < Temp.length; i++) {
                        ...
                        RequestAPI("GetMailMentionList", {}, async (Response) => {
                            if (Response.Success) {
                                ...
                                for (let i = 0; i < MentionList.length; i++) {
                                    ...
                                    let ToastBody = document.createElement("div");
                                    ToastBody.classList.add("toast-body");
                                    ToastBody.innerHTML = "来自用户" + MentionList[i].FromUserID + "的消息";
                                    let ToastFooter = document.createElement("div");
                                    ToastFooter.classList.add("mt-2", "pt-2", "border-top");
                                    let ToastDismissButton = document.createElement("button");
                                    ToastDismissButton.type = "button";
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    if (document.querySelector("body > div > div.mt-3 > h2") != null) {
                        ...
                        let Temp = document.querySelectorAll(".sampledata");
                        for (var i = 0; i < Temp.length; i++) {
