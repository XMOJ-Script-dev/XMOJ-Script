...
// @updateURL    https://xmoj-bbs.tech/XMOJ.user.js
...
async function main() {
  ...
  if (location.host != "www.xmoj.tech") {
    ...
    if (document.querySelector("#navbar") != null) {
      ...
      fetch(ServerURL + "/AddonScript.js", {
          cache: "no-cache"
        })
        .then((Response) => {
          return Response.text();
    ...
    <center class="mt-3">
        ...
        if (SearchParams.get("ByUserScript") != null) {
          ...
          await fetch(ServerURL + "/Update.json", {
              cache: "no-cache"
            })
            .then((Response) => {
              return Response.json();
          ...
          ModifyInfo.addEventListener("click", async () => {
            ...
            await fetch("https://www.xmoj.tech/modify.php", {
              ...
              "referrer": location.href,
              "method": "POST",
              "body": "nick=" + encodeURIComponent(Nickname) + "&" +
